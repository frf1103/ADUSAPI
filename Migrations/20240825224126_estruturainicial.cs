        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    multiplo = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    idconta = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    uidlog = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    datains = table.Column<DateTime>(type: "datetime2", nullable: true),
                    dataup = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoExterno = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Rendimento = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Consumo = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    uid = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    datains = table.Column<DateTime>(type: "datetime2", nullable: true),
                    dataup = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Produtos_Unidades_idunidade",
            ...
            migrationBuilder.CreateTable(
                name: "ProdutoPrincipio",
                columns: table => new
                {
                    idconta = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    idproduto = table.Column<int>(type: "int", nullable: false),
                    idprincipio = table.Column<int>(type: "int", nullable: false),
                    quantidade = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProdutoPrincipio", x => new { x.idconta, x.idproduto, x.idprincipio });
                    table.ForeignKey(
                        name: "FK_ProdutoPrincipio_Contas_idconta",
                        column: x => x.idconta,
                        principalTable: "Contas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProdutoPrincipio_PrincipiosAtivos_idprincipio",
                        column: x => x.idprincipio,
                        principalTable: "PrincipiosAtivos",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProdutoPrincipio_Produtos_idproduto_idconta",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PopulacaoRecomendada = table.Column<int>(type: "int", nullable: true),
                    Germinacao = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    PMS = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Espacamento = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    MargemSeguranca = table.Column<decimal>(type: "decimal(6,2)", precision: 6, scale: 2, nullable: true),
                    Stand = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    UnidadeSementePrevista = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    QtdSementePrevista = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    ProdEstimada = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    uid = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    datains = table.Column<DateTime>(type: "datetime2", nullable: true),
                    dataup = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProdutosOrcamento_PrincipiosAtivos_IdPrincipioAtivo",
                        column: x => x.IdPrincipioAtivo,
                        principalTable: "PrincipiosAtivos",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustoOperacao = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    uid = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    datains = table.Column<DateTime>(type: "datetime2", nullable: true),
                    dataup = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdutoPrincipio_idprincipio",
                table: "ProdutoPrincipio",
                column: "idprincipio");

            migrationBuilder.CreateIndex(
                name: "IX_ProdutoPrincipio_idproduto_idconta",
                table: "ProdutoPrincipio",
                columns: new[] { "idproduto", "idconta" });

            migrationBuilder.CreateIndex(
                name: "IX_Produtos_idconta",
                table: "Produtos",
                column: "idconta");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdutosOrcamento_IdPrincipioAtivo",
                table: "ProdutosOrcamento",
